...
export default function App() {
    ...
    const handleValueChange = (valores) => {
      ...
      for(let i = 1; i <= valores.parcelas; i++) {
        let valorPorcentagem = (parseFloat(valores.montante) * parseFloat(valores.juros)) / 100;
        ...
        listaTemp.push({
          ...
          valorCorrespondenteAPorcentagem: valorCorrespondenteAPorcentagem.toFixed(2)
        });
