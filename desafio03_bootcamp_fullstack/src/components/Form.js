        ...
        <div>
            <form className={css.flexRow}>
                <div style={{width: '32%'}} className="input-field">
                    <input onChange={handleInputChangeMontante} id="inputMontanteInicial" type="number" step="100" value={montante} />
                ...
                <div style={{width: '32%'}} className="input-field">
                    <input onChange={handleInputChangeJuros} id="inputJurosMensal" type="number" step="0.1" min="-12" max="12" value={juros}/>
                ...
                <div style={{width: '32%'}} className="input-field">
                    <input  onChange={handleInputChangeParcelas} id="inputParcelas" type="number" step="1" min="1" max="36" value={parcelas} />
